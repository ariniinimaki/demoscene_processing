...
public class first_demo extends PApplet {
...
public void draw() {
  ...
  rotateY((mouseX - width/2) * 0.001f);
  rotateX((mouseY - height/2) * -0.001f);
  ...
  float sphereY = abs(sin(secs*2.0f)) * -400.0f;
 ...
 */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "first_demo" };
    if (passedArgs != null) {
